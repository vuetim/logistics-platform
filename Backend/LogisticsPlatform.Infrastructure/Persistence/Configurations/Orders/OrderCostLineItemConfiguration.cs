...
{
    public class OrderCostLineItemConfiguration : IEntityTypeConfiguration<OrderCostLineItem>
    {
        public void Configure(EntityTypeBuilder<OrderCostLineItem> builder)
        {
