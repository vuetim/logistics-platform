...
namespace LogisticsPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20251126235548_SetPrecisionOnLoadEquipmentDecimals")]
    partial class SetPrecisionOnLoadEquipmentDecimals
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 26, 23, 55, 47, 756, DateTimeKind.Utc).AddTicks(2192),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2"),
                            CreatedAt = new DateTime(2025, 11, 26, 23, 55, 47, 756, DateTimeKind.Utc).AddTicks(2205),
                            Name = "Broker"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3"),
                            CreatedAt = new DateTime(2025, 11, 26, 23, 55, 47, 756, DateTimeKind.Utc).AddTicks(2222),
                            Name = "Operator"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4"),
                            CreatedAt = new DateTime(2025, 11, 26, 23, 55, 47, 756, DateTimeKind.Utc).AddTicks(2225),
                            Name = "Dispatcher"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5"),
                            CreatedAt = new DateTime(2025, 11, 26, 23, 55, 47, 756, DateTimeKind.Utc).AddTicks(2228),
                            Name = "Accounting"
                        });
                });
