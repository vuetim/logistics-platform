...
namespace LogisticsPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20251126164749_AddSystemRolesSeed")]
    partial class AddSystemRolesSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 26, 16, 47, 48, 74, DateTimeKind.Utc).AddTicks(2441),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2"),
                            CreatedAt = new DateTime(2025, 11, 26, 16, 47, 48, 74, DateTimeKind.Utc).AddTicks(2457),
                            Name = "Broker"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3"),
                            CreatedAt = new DateTime(2025, 11, 26, 16, 47, 48, 74, DateTimeKind.Utc).AddTicks(2461),
                            Name = "Operator"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4"),
                            CreatedAt = new DateTime(2025, 11, 26, 16, 47, 48, 74, DateTimeKind.Utc).AddTicks(2465),
                            Name = "Dispatcher"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5"),
                            CreatedAt = new DateTime(2025, 11, 26, 16, 47, 48, 74, DateTimeKind.Utc).AddTicks(2468),
                            Name = "Accounting"
                        });
                });
