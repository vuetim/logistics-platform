...
namespace LogisticsPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260520095453_AddNotificationsSearchSalesOperationalAccess")]
    partial class AddNotificationsSearchSalesOperationalAccess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarrierStopPerformance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DelayResponsibility", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DelayResponsibilities");
                });
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Load", b =>
                {
                    ...
                    b.Property<DateTime?>("LastKnownLocationAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("OnTimeDelivery")
                        .HasColumnType("bit");

                    b.Property<bool>("OnTimePickup")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTime?>("PodReceivedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("PodUploadedBy")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RateConfirmationNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Status")
                        .HasColumnType("int");

                    b.Property<string>("TrackingExternalId")
                        .HasMaxLength(160)
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.LoadAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LoadAlerts");
                });

            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.LoadCarrierAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("TenderExpiresAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("TenderNotes")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("TenderedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("TenderExpiresAt");

                    b.HasIndex("CarrierId", "Status");

                    b.HasIndex("LoadId", "IsActive");

                    b.ToTable("LoadCarrierAssignments");
                });
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.LoadDelayResponsibility", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LoadDelayResponsibilities");
                });
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.LoadEquipment", b =>
                {
                    ...
                    b.Property<Guid?>("SourceOrderEquipmentRequirementId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.LoadException", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AffectedItemName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("AffectedItemReference")
                        .HasMaxLength(120)
                    ...
                    b.Property<string>("EdiReasonCode")
                        .HasMaxLength(20)
                    ...
                    b.Property<string>("ExceptionValue")
                        .IsRequired()
                        .HasMaxLength(160)
                        .HasColumnType("nvarchar(160)");
                    ...
                    b.Property<string>("ResponsiblePartyKey")
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");

                    b.Property<string>("ResponsiblePartyValue")
                        .HasMaxLength(160)
                        .HasColumnType("nvarchar(160)");
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.LoadStop", b =>
                {
                    ...
                    b.Property<DateTime?>("ActualCheckedInTime")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ActualCheckedOutTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("DelayRisk")
                        .HasColumnType("int");

                    b.Property<string>("DelayRiskReason")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsLateDeparture")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("MinutesLatePrediction")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("PredictedArrivalAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("StopType", "PlannedArrivalFrom");

                    b.HasIndex("StopType", "PlannedArrivalTo");

                    b.HasIndex("LoadId", "StopType", "Sequence");

                    b.ToTable("LoadStops");
                });

            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.LoadStopServiceRequirement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LoadStopId", "ServiceKey");

                    b.ToTable("LoadStopServiceRequirements");
                });
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("PrimaryBolNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PrimaryPONumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PrimaryProNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.OrderRoute", b =>
                {
                    ...
                    b.HasIndex("OrderId", "IsActive", "StopType", "Sequence");

                    b.ToTable("OrderRoutes");
                });

            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 26, 16, 47, 48, 0, DateTimeKind.Utc),
                            Name = "Admin"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Security.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Security.UserTablePreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserTablePreferences", (string)null);
                });
            ...
            modelBuilder.Entity("Customer", b =>
                {
                    b.OwnsOne("CustomerBillingInfo", "Billing", b1 =>
                        {
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.LoadException", b =>
                {
                    ...
                    b.HasOne("LogisticsPlatform.Domain.Entities.LoadStop", "LoadStop")
                        .WithMany()
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.OrderEquipmentRequirement", b =>
                {
                    b.HasOne("LogisticsPlatform.Domain.Entities.Order", null)
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Security.UserNotification", b =>
                {
                    b.HasOne("LogisticsPlatform.Domain.Entities.User", "ActorUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Load", b =>
                {
                    b.Navigation("CarrierAssignments");
