...
namespace LogisticsPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20251201030511_FixUserCascadePaths")]
    partial class FixUserCascadePaths
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 1, 3, 5, 11, 225, DateTimeKind.Utc).AddTicks(9192),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2"),
                            CreatedAt = new DateTime(2025, 12, 1, 3, 5, 11, 225, DateTimeKind.Utc).AddTicks(9208),
                            Name = "Broker"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3"),
                            CreatedAt = new DateTime(2025, 12, 1, 3, 5, 11, 225, DateTimeKind.Utc).AddTicks(9211),
                            Name = "Operator"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4"),
                            CreatedAt = new DateTime(2025, 12, 1, 3, 5, 11, 225, DateTimeKind.Utc).AddTicks(9213),
                            Name = "Dispatcher"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5"),
                            CreatedAt = new DateTime(2025, 12, 1, 3, 5, 11, 225, DateTimeKind.Utc).AddTicks(9215),
                            Name = "Accounting"
                        });
                });
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("CustomerAddress", "DestinationAddress")
                        .WithMany()
                        .HasForeignKey("DestinationAddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CustomerAddress", "OriginAddress")
                        .WithMany()
