...
namespace LogisticsPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20251126235117_AddLoadModuleInitial")]
    partial class AddLoadModuleInitial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 26, 23, 51, 15, 782, DateTimeKind.Utc).AddTicks(3146),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2"),
                            CreatedAt = new DateTime(2025, 11, 26, 23, 51, 15, 782, DateTimeKind.Utc).AddTicks(3165),
                            Name = "Broker"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3"),
                            CreatedAt = new DateTime(2025, 11, 26, 23, 51, 15, 782, DateTimeKind.Utc).AddTicks(3169),
                            Name = "Operator"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4"),
                            CreatedAt = new DateTime(2025, 11, 26, 23, 51, 15, 782, DateTimeKind.Utc).AddTicks(3171),
                            Name = "Dispatcher"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5"),
                            CreatedAt = new DateTime(2025, 11, 26, 23, 51, 15, 782, DateTimeKind.Utc).AddTicks(3174),
                            Name = "Accounting"
                        });
                });
