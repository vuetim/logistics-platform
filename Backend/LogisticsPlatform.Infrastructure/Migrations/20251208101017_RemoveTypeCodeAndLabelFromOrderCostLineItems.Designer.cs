...
namespace LogisticsPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20251208101017_RemoveTypeCodeAndLabelFromOrderCostLineItems")]
    partial class RemoveTypeCodeAndLabelFromOrderCostLineItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogisticsPlatform.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 8, 10, 10, 16, 528, DateTimeKind.Utc).AddTicks(9696),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2"),
                            CreatedAt = new DateTime(2025, 12, 8, 10, 10, 16, 528, DateTimeKind.Utc).AddTicks(9708),
                            Name = "Broker"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3"),
                            CreatedAt = new DateTime(2025, 12, 8, 10, 10, 16, 528, DateTimeKind.Utc).AddTicks(9710),
                            Name = "Operator"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4"),
                            CreatedAt = new DateTime(2025, 12, 8, 10, 10, 16, 528, DateTimeKind.Utc).AddTicks(9712),
                            Name = "Dispatcher"
                        },
                        new
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5"),
                            CreatedAt = new DateTime(2025, 12, 8, 10, 10, 16, 528, DateTimeKind.Utc).AddTicks(9714),
                            Name = "Accounting"
                        });
                });
